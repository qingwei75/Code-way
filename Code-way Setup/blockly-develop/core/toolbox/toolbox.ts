...
//   // 获取 blocklyFlyout 元素
//   var aaa = document.querySelector('.blocklyFlyout') as HTMLElement;

//   // 定义新元素的 HTML 字符串
//   var newElementHTML = '<svg class="blocklyFlyout" width="157.78024291992188" height="660" data-cached-width="157.78024291992188" data-cached-height="660" style="display: block; transform: translate(207px, 0px);"><path class="blocklyFlyoutBackground" d="M 0,0 h 149.78024291992188 a 8 8 0 0 1 8 8 v 644 a 8 8 0 0 1 -8 8 h -149.78024291992188 z"></path></svg>';

//   // 在 aaa 元素后面插入新元素
//   aaa.insertAdjacentHTML('afterend', newElementHTML);
// }
